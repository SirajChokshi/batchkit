...
See how your requests are being batched and scheduled in real-time in a browser environment. For other usage, see the [server-side tracing](/docs/guide#server-side-tracing) section in the guide.
